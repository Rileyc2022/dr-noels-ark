import { Auth, createUserWithEmailAndPassword, GoogleAuthProvider, sendPasswordResetEmail, signInWithEmailAndPassword, signInWithPopup, updateEmail, updatePassword, User, UserCredential } from "firebase/auth";
...
export function AuthProvider({ children }: { children: React.ReactChild }) {
  ...
  function updateUserPassword(user: User, newPassword: string): Promise<void> | null {
